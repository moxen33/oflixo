        ...
        <Row>
            ...
            <div className="sub-product inner-box">
              <div className="product-block">
                {isSale ? (
                  ...
                  <span className="onsale bg-dark">{t("streamShop.new")}</span>
                ) : (
                  ""
                )}
                <Link to="#">
          ...
          <Col lg="6">
            <div className="summary ms-lg-4">
              ...
              <div className="">
                {t("streamShop.sku")} : <span> {props.sku}</span>
              </div>
              <br />
              <div className="mb-3">
                {t("streamButtons.category")} :{" "}
                  ...
                  <div id="additional-info" className="streamit-reviews">
                    <div className="description-content">
                      <table className="addtable mb-5">
                        <tbody>
                          <tr>
                            <th className="thwidth">{t("streamShop.size")}</th>
                          ...
                          <tr>
                            <th className="thwidth">{t("streamShop.color")}</th>
                            <td className="bordertd">
                              <span
