export const blogsDetails = [
   {
      id: 1,
      slug: "simple-blog",
      detail: `<h6 class="text-white my-3">
      mattis, arcu lorem blandit nisl, non laoreet dui
                              mi eget elit. Donec porttitor ex vel augue maximus luctus. Vivamus finibus nibh eu nunc
                              volutpat suscipit.</h6>
                        <p class="mb-0 blog-gallery-desc">Nam vulputate libero quis nisi euismod rhoncus. Sed eu euismod felis. Aenean ullamcorper
                           ...
                           scelerisque.</p>
                        <p class="blog-gallery-desc">Sed leo elit, volutpat quis aliquet eu, elementum eget arcu. Aenean ligula tellus, malesuada
                     ...
                     <blockquote class="block-quote text-white py-2">
                        <p class="mb-0 blog-gallery-desc">\”Simon Doe has his tongue planted in his cheek as he describes the fictional skills of his
                advancing agent.\”</p>
                        <cite><a href="#">Steve Kowalsky</a></cite>
                     </blockquote>
                     <p class="mb-0 blog-gallery-desc">Potenti fusce himenaeos hac aenean quis donec vivamus aliquet, wprdpress integer inceptos curae
                     ...
                     <p class="mb-0 blog-gallery-desc">Nisi habitasse viverra praesent a maecenas odio erat tristique praesent elementum rutrum
                     ...
                     <p class="blog-gallery-desc">Potenti fusce himenaeos hac aenean quis donec vivamus aliquet, wprdpress integer inceptos curae
                        sollicitudin in class sociosqu netus, euismod tempus fermentum odio gravida eleifend viverra
                        pulvinar inceptos ligula consectetur. Potenti ante porttitor tristique curae scelerisque
                        tristique, dictum eu donec conubia sit rutrum duis viverra in commodo.</p>`
   },
...

   {
    ...
    <div className="blog-single-icon mt-0">
                <a className="link-icon" href="https://iqonic.design">
                    <i aria-hidden="true" className="ph ph-link mb-2"></i>
                    </a>
            </div>
                        <p><strong>Praesent iaculis, purus ac vehicula mattis, arcu lorem blandit nisl, non laoreet dui
                              mi eget elit. Donec porttitor ex vel augue maximus luctus. Vivamus finibus nibh eu nunc
   ...
   },
   {
      ...
      detail: `<div className="blog-content">
    <img src="/assets/images/blog/audio.webp" className="img-fluid mb-5" alt="01">
                        <h6><strong>Praesent iaculis, purus ac vehicula mattis, arcu lorem blandit nisl, non laoreet dui
                              mi eget elit. Donec porttitor ex vel augue maximus luctus. Vivamus finibus nibh eu nunc
                              volutpat suscipit.</strong></h6>
                        <p>Nam vulputate libero quis nisi euismod rhoncus. Sed eu euismod felis. Aenean ullamcorper
                           dapibus odio ac tempor. Aliquam iaculis, quam vitae imperdiet consectetur, mi ante semper
                           metus, ac efficitur nisi justo ut eros. Maecenas suscipit turpis fermentum elementum
                           scelerisque.</p>
  ...
  `,
   },
   {
      id: 8,
      slug: 'blog-template',
      detail: `<p className="pb-4">Integer volutpat ex scelerisque neque convallis tempus. Fusce eu rutrum leo. Curabitur
      pellentesque nisl at mattis ornare. Morbi odio nisl, cursus eget eleifend a, molestie eu orci. Quisque aliquam
      blandit libero vitae vestibulum. Aenean <span className="text-primary fw-bold">“rutrum nisi at lectus”</span>
      ...
      <div className="blockquote text-center mb-3">
          ...
          <div className="my-4">
            <h6 className="border-gredient-left d-inline-block ps-2 fw-normal py-1"> Walt Disney </h6>
          </div>
        </div>
        <p className="pt-4"> Collaboratively administrate empowered markets via plug-and-play networks. Dynamically
          procrastinate B2C users after installed base Dramatically visualize customer directed <span className="text-white text-decoration-underline">convergence without revolutionary</span> ROI Cras at sem
          efficitur, pellentesque erat sed, ullamcorper </p>
          <h4 className="mb-3 mt-5 pt-2">Middle Title Heading</h4>
          ...
          <div className="col-lg-10">
            <div className="position-relative padding-200 blog-background" style=" background-size:cover">
              <div className="iq-popup-video">
                 <div className="iq-video-icon position-absolute ">
                    <div className="iq-video bg-primary position-absolute text-center d-inline-block iq-fslightbox-img">
                       <a className="d-block" data-fslightbox="html5-video" href="https://www.youtube.com/watch?v=VeDdpy4CdeM" data-video-poster="<i aria-hidden=&quot;true&quot; class=&quot;fas fa-play text-primary&quot;></i>">
                       <i aria-hidden="true" className="fas fa-play text-white"></i>
                       </a>
                    </div>
        ...
        <ul>
          <li className="mb-3">Mauris faucibus, quam et placerat tempor, <span className="text-white text-capitalize"> nunc urna
              rutrum metus</span> sit amet auctor nulla </li>
          <li className="mb-3">Mauris faucibus, quam et placerat tempor, nunc urna rutrum metus, sit amet auctor</li>
          <li>Quisque nec sapien vel quam <span className="text-primary fw-bold fst-italic"> “venenatis fringilla”</span> a
