        ...
        <Col sm="12">
          ...
          <Col sm="12">
            ...
            <Masonry
              ...
              className="row"
              columnClassName="col-sm-6 col-lg-4"
            >
              {/* Card 1 */}
              <Card className="mb-3">
                <Card.Img src={img07} alt="#" loading="lazy" />
                <Card.Body>
              ...
              <Card className="text-center mb-3">
                <Card.Body>
                  <Card.Title>Card title</Card.Title>
                  <Card.Text>This card has a regular title and short paragraph of text below it.</Card.Text>
                  <Card.Text>
                    <small className="text-muted">Last updated 3 mins ago</small>
                  </Card.Text>
                </Card.Body>
              ...
              {/* Card 4 - Blockquote with bg-primary */}
              ...
              {/* Card 7 - Right aligned blockquote */}
              <Card className="mb-3">
