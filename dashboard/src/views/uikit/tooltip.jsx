        ...
        <Col sm="12" lg="6">
          <Card>
            ...
            <Card.Body>
              ...
              <OverlayTrigger
                placement={`${themeSchemeDirection === "ltr" ? "left" : "top"}`}
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <OverlayTrigger
                ...
                overlay={<Tooltip>Tooltip on top</Tooltip>}
              >
                <Button variant="primary" className="mt-2">Tooltip on top</Button>
              </OverlayTrigger>{" "}
              <OverlayTrigger
                placement="right"
                overlay={<Tooltip>Tooltip on right</Tooltip>}
              >
                <Button variant="success" className="mt-2">Tooltip on right</Button>
              </OverlayTrigger>{" "}
              <OverlayTrigger
                placement="bottom"
                overlay={<Tooltip>Tooltip on bottom</Tooltip>}
              >
                <Button variant="danger" className="mt-2">Tooltip on bottom</Button>
              </OverlayTrigger>{" "}
              <OverlayTrigger
                placement={`${themeSchemeDirection === "ltr" ? "left" : "top"}`}
                overlay={<Tooltip>Tooltip on left</Tooltip>}
              >
                <Button variant="info" className="mt-2">Tooltip on left</Button>
              </OverlayTrigger>{" "}
            </Card.Body>
          </Card>
          <Card>
            ...
            <Card.Body>
              ...
              <OverlayTrigger
                ...
                overlay={<Tooltip>Tooltip on top</Tooltip>}
              >
                <Button variant="primary-subtle" className="mt-2">
                  Tooltip on top
                </Button>
              </OverlayTrigger>{" "}
              <OverlayTrigger
                ...
                overlay={<Tooltip>Tooltip on right</Tooltip>}
              >
                <Button variant="success-subtle" className="mt-2">
                  Tooltip on right
                </Button>
              </OverlayTrigger>{" "}
              <OverlayTrigger
                ...
                overlay={<Tooltip>Tooltip on bottom</Tooltip>}
              >
                <Button variant="danger-subtle" className="mt-2">
                  Tooltip on bottom
                </Button>
              </OverlayTrigger>{" "}
              <OverlayTrigger
                ...
                overlay={<Tooltip>Tooltip on left</Tooltip>}
              >
                <Button variant="info-subtle" className="mt-2">
                  Tooltip on left
                </Button>
              </OverlayTrigger>{" "}
            </Card.Body>
