          ...
          <Card>
            ...
            <Card.Body>
              ...
              <div className="iq-example-row iq-example-row-flex-cols">
                <Container fluid>
                  <Row className="align-items-start bg-primary-subtle">
                  ...
                  <Row className="align-items-end bg-primary-subtle">
                    <Col>One of three columns</Col>
                    <Col>One of three columns</Col>
                    <Col>One of three columns</Col>
                  </Row>
          ...
          <Card>
            ...
            <Card.Body>
              <p>
                ...
                break to a new line. Make the breaks responsive by mixing the{" "}
                <code>.w-100</code> with some{" "}
                <Link href="https://getbootstrap.com/docs/5.0/utilities/display/">
                  responsive display utilities
                </Link>
                .
              </p>
