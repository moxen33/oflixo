...
//Image
import shap1 from "/assets/images/author/01.png";
import shap2 from "/assets/images/author/02.png";
import shap3 from "/assets/images/author/03.png";
import shap4 from "/assets/images/author/04.png";
import shap5 from "/assets/images/author/05.png";
            ...
            <Card.Body>
              <div className="mb-5">
                <div className="mb-2 d-flex justify-content-between align-items-center">
                  ...
                  <Link className="badge rounded-pill bg-primary-subtle" to="#">
              ...
              <div className="d-flex gap flex-column">
                ...
                <div className="d-flex align-items-center gap-3">
                  <div className="bg-info-subtle avatar-60 rounded">
                    <svg
                      className="icon-35"
                      width="35"
                      viewBox="0 0 24 24"
                ...
                <div className="d-flex align-items-center gap-3">
                  <div className="bg-success-subtle avatar-60 rounded">
                    <svg
                      className="icon-35"
                      width="35"
                      viewBox="0 0 24 24"
                ...
                <div className="d-flex align-items-center gap-3">
                  <div className="bs-danger-subtle avatar-60 rounded">
                    <svg
                      className="icon-35"
                      width="35"
                      viewBox="0 0 24 24"
                  ...
                  <div style={{ width: "100%" }}>
                    ...
                    <div
                      className="progress bs-danger-subtle shadow-none w-100"
                      style={{ height: "6px" }}
                    >
                      <div
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <div
                          className="shadow-none progress bg-primary-subtle w-100"
                          style={{ height: "4px" }}
                        >
                          <div
                            className="progress-bar bg-primary"
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div
                          className="shadow-none progress bs-success-subtle w-100"
                          style={{ height: "4px" }}
                        >
                          <div
                            className="progress-bar bg-success"
            ...
            <Card.Body>
              <div className="d-flex justify-content-between  mb-3">
                <div className="w-100">
                  ...
                  <div className="d-flex align-items-center">
                    <div
                      className="progress bs-success-subtle shadow-none w-50"
                      style={{ height: "6px" }}
                    >
                      <div
                        className="progress-bar bg-success"
              ...
              <div className="d-flex justify-content-between  mb-3">
                <div className="w-100">
                  ...
                  <div className="d-flex align-items-center">
                    <div
                      className="progress bs-danger-subtle shadow-none w-50"
                      style={{ height: "6px" }}
                    >
                      <div
                        className="progress-bar bg-danger"
              ...
              <div className="d-flex justify-content-between  mb-3">
                <div className="w-100">
                  ...
                  <div className="d-flex align-items-center">
                    <div
                      className="progress bg-primary-subtle shadow-none w-50"
                      style={{ height: "6px" }}
                    >
                      <div
                        className="progress-bar bg-primary"
              ...
              <div className="d-flex justify-content-between  mb-3">
                <div className="w-100">
                  ...
                  <div className="d-flex align-items-center">
                    <div
                      className="progress bs-gray-subtle shadow-none w-50"
                      style={{ height: "6px" }}
                    >
                      <div
