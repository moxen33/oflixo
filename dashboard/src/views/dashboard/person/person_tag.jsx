      ...
      <Row className="streamit-wraper-table2">
        ...
        <Col lg={8}>
          <Card>
            <Card.Header>
              <h2 className="episode-playlist-title wp-heading-inline">
                <span className="position-relative ">{t("addpage.tag-list")} </span>
              </h2>
            </Card.Header>
            <Card.Body>
            ...
            <Form>
              <div className="section-form">
                <Row>
                  <Col lg={12}>
                    <Form.Group className="form-group">
                      ...
                      <Form.Control
                        ...
                        type="text"
                        placeholder={t("bordertable.producer")}
                        data-id="multiple"
                      />
                    </Form.Group>
                  </Col>
                  ...
                  <Col lg={12}>
                    <Form.Group className="form-group">
                      <Form.Label htmlFor="Description">{t("addpage.tag-description")}</Form.Label>
                      <Form.Control
                        as="textarea"
                        id="Description"
                        className="form-control"
