      ...
      <Row className="streamit-wraper-table2">
          ...
          <Card >
            <Card.Header>
              <h2 className="episode-playlist-title wp-heading-inline">
                <span className="position-relative ">{t("addpage.add-new-category")}</span>
              </h2>
            </Card.Header>
            <Card.Body>
              <Form>
                ...
                <Form.Group className="form-group">
                  ...
                  {t("addpage.category-slug")} <span className="text-danger">*</span>
                  </Form.Label>
                  <Form.Control
                    type="text"
                    id="genre-slug"
        ...
        <Col lg={8}>
          <Card>
            <Card.Header>
              <h2 className="episode-playlist-title wp-heading-inline">
                <span className="position-relative ">{t("addpage.person-categories")}</span>
              </h2>
            </Card.Header>
            <Card.Body>
        ...
        >
            ...
            <Form>
              <div className="section-form">
                <Row>
                  ...
                  <Col lg={12}>
                    <Form.Group className="form-group">
                      <Form.Label htmlFor="Description">{t("addpage.category-description")}</Form.Label>
                      <Form.Control
                        as="textarea"
                        id="Description"
                        className="form-control"
          ...
          <div className="offcanvas-footer border-top">
            <div className="d-grid d-flex gap-3 p-3">
              <Button variant="primary" type="submit" className="d- d-flex align-items-center gap-2">
...
export default Person_category;
