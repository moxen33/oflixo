...
import shap6 from "/assets/images/author/06.png";
              ...
              <Card.Body>
                <div className="d-grid gap-card grid-cols-3">
                  <Link onClick={() => setToggler(!toggler)} to="#">
                    <Image
                      src={icon4}
                      className="img-fluid bs-info-subtle rounded"
                      alt="profile-image"
                    />
                  </Link>
                  <Link onClick={() => setToggler(!toggler)} to="#">
                  ...
                  <Link onClick={() => setToggler(!toggler)} to="#">
                    <Image
                      src={icon1}
                      className="img-fluid bs-success-subtle rounded"
                      alt="profile-image"
                    />
                  </Link>
                </div>
            ...
            <Card>
              ...
              <Card.Body>
                <ul className="list-inline m-0 p-0">
                  ...
                  <li className="d-flex mb-4 align-items-center">
                    <div className="img-fluid bs-dark-subtle rounded-pill">
                      <Image
                        src={avatars4}
                        alt="story-img"
                        className="rounded-pill avatar-40"
                  ...
                  <li className="d-flex mb-4 align-items-center">
                    <div className="img-fluid bs-info-subtle rounded-pill">
                      <Image
                        src={avatars6}
                        alt="story-img"
                        className="rounded-pill avatar-40"
                  ...
                  <li className="d-flex mb-4 align-items-center">
                    <div className="img-fluid bs-success-subtle rounded-pill">
                      <Image
                        src={avatars8}
                        alt="story-img"
                        className="rounded-pill avatar-40"
