...
const EpisdoePlaylist = () => {
  ...
  const tableData = [
    {
      title: "Radhe Krishna Stories",
      slug: "radhe-krishna-stories",
    },

    {
      title: "episodes of pius",
      slug:"episodes-of-pius",
    },
    ...
    },
    {
      ...
      render: function () {
        ...
        <div class="d-flex align-items-center list-user-action gap-2">
          ...
          <a title="Viw" class="btn btn-sm btn-icon btn-info-subtle rounded" data-table="action" data-id="0" data-method="view" href="#"><i class="ph ph-eye fs-6"></i></a>
        </div>
          `;
      },
    },
            ...
            <Card.Body>
              <Form>
                <Form.Group className="form-group">
                  <Form.Label className="form-label" htmlFor="episode-name">
                ...
                <Form.Group className="form-group">
                  <Form.Label htmlFor="episode-slug">
            ...
            <Card.Body>
              <div className="table-view table-responsive  table-space">
                <table
                  id="seasonTable"
                  ref={tableRef}
                  className="data-tables table custom-table movie_table my-2 dataTable no-footer"
                ></table>
              </div>
            </Card.Body>
          </Card>
...
export default EpisdoePlaylist;
