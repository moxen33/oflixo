      ...
      <Row className="streamit-wraper-table2">
          ...
          <Card >
            <Card.Header>
              <h2 className="episode-playlist-title wp-heading-inline">
                <span className="position-relative ">{t("addpage.add_new_genre")} </span>
              </h2>
            </Card.Header>
            <Card.Body>
              <Form>
                <Form.Group className="form-group">
                  ...
                  {t("addpage.genre-name")} <span className="text-danger">*</span>
                  </Form.Label>
                  <Form.Control
                    type="text"
                    className=""
                ...
                <Form.Group className="form-group">
                  ...
                  {t("addpage.genre-slug")} <span className="text-danger">*</span>
                  </Form.Label>
                  <Form.Control
                    type="text"
                    id="genre-slug"
                ...
                <Form.Group className="form-group">
                  <Form.Label htmlFor="parent-genre">{t("addpage.parent-genre")}</Form.Label>
                  <ChoicesJs
                ...
                ></ImageUpload>
                <Form.Group className="form-group">
                  <Form.Label>{t("addpage.genre-description")}</Form.Label>
                  <Form.Control
                    as="textarea"
                    rows="7"
        ...
        <Col lg={8}>
          <Card>
            <Card.Header>
              <h2 className="episode-playlist-title wp-heading-inline">
                <span className="position-relative ">{t("addpage.tvshow-genre")} </span>
              </h2>
            </Card.Header>
            <Card.Body>
                        ...
                        <Row>
                          <Col lg={12}>
                            <Form.Group className="form-group">
                              ...
                              {t("addpage.genre-name")} <span className="text-primary">{" "}*</span>
                              </Form.Label>
                              <Form.Control
                          ...
                          <Col lg={12}>
                            <Form.Group className="form-group">
                              <Form.Label className="form-label flex-grow-1" htmlFor="genres">
                              {t("addpage.genre-slug")} <span className="text-primary">{" "}*</span>
                              </Form.Label> 
                              <Form.Control
                                className="form-control"
                                type="text"
