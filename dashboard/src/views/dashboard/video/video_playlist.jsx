      ...
      <Row className="streamit-wraper-table2">
          ...
          <Card>
            <Card.Header>
              <h2 className="episode-playlist-title wp-heading-inline">
                <span className="position-relative ">{t("addpage.add-new-video-playlist")} </span>
              </h2>
            </Card.Header>
            <Card.Body>
              <Form>
                <Form.Group className="form-group">
                  <Form.Label className="form-label" htmlFor="playlist-name">
                  ...
                  <Form.Control
                    ...
                    className=""
                    id="playlist-name"
                    placeholder={t("addpage.enter-name-video-playlist")}
                  />
                </Form.Group>
                <Form.Group className="form-group">
                  <Form.Label htmlFor="playlist-slug">
                  {t("addpage.playlist_slug")} <span className="text-danger">*</span>
                  </Form.Label>
                  <Form.Control
                    type="text"
                    id="playlist-slug"
                    placeholder={t("addpage.enter-slug-video-playlist")}
                  />
                </Form.Group>

                <div className="d-flex align-items-center justify-content-end mt-4">
                  <Button variant="primary" className="custom-add-button">
                  {t("addpage.add-video-playlist")}
                  </Button>
                </div>
              </Form>
            </Card.Body>
        ...
        <Col lg={8}>
          <Card>
            <Card.Header>
              <h2 className="episode-playlist-title wp-heading-inline">
                <span className="position-relative "> {t("sidebar.video-playlist")} </span>
              </h2>
            </Card.Header>
            <Card.Body>
        ...
        >
          <Offcanvas.Header closeButton>
            <h2 className="episode-playlist-title wp-heading-inline">
              ...
              {t("addpage.update-video-playlist")}
              </Offcanvas.Title>
            </h2>
          </Offcanvas.Header>
          <Offcanvas.Body>
