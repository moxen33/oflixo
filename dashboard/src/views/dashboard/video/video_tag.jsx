      ...
      <Row className="streamit-wraper-table2">
          ...
          <Card>
            <Card.Header>
              <h2 className="episode-playlist-title wp-heading-inline">
                <span className="position-relative ">{t("addpage.add-new-video-tag")} </span>
              </h2>
            </Card.Header>
            <Card.Body>
              <Form>
                <Form.Group className="form-group">
                  <Form.Label className="form-label" htmlFor="tag-name">
                  {t("addpage.tag-name")} <span className="text-danger">*</span>
                  </Form.Label>
                  <Form.Control
                    type="text"
                    className=""
                ...
                <Form.Group className="form-group">
                  <Form.Label htmlFor="tag-slug">
                  {t("addpage.tag-slug")} <span className="text-danger">*</span>
                  </Form.Label>
                  <Form.Control
                    type="text"
                    id="tag-slug"
                ...
                <Form.Group className="form-group">
                  <Form.Label>{t("addpage.tag-description")}</Form.Label>
                  <Form.Control
                    as="textarea"
                    rows="7"
        ...
        <Col lg={8}>
          <Card>
            <Card.Header>
              <h2 className="episode-playlist-title wp-heading-inline">
                <span className="position-relative ">{t("sidebar.video-tags")} </span>
              </h2>
            </Card.Header>
            <Card.Body>
            ...
            <Form>
              <div className="section-form">
                <Row>
                  <Col lg={12}>
                    <Form.Group className="form-group">
                      <Form.Label className="form-label flex-grow-1" htmlFor="tags">
                      {t("addpage.tag-name")} <span className="text-primary"> *</span>
                      </Form.Label>
                      <Form.Control
                        className="form-control"
                        type="text"
                        placeholder={t("addpage.vikings")}
                        data-id="multiple"
                      />
                    </Form.Group>
                  </Col>
                  <Col lg={12}>
                    <Form.Group className="form-group">
                      <Form.Label className="form-label flex-grow-1" htmlFor="tags">
                      {t("addpage.tag-slug")} <span className="text-primary"> *</span>
                      </Form.Label>
                      <Form.Control
                        className="form-control"
                        type="text"
