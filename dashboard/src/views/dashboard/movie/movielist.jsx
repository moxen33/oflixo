...
import venom from "/assets/images/movie-thumb/venom.webp";
import rabbit from "/assets/images/movie-thumb/rabbit.webp";
import migration from "/assets/images/movie-thumb/migration.webp";
import krishna from "/assets/images/movie-thumb/krishna.webp";
import kali from "/assets/images/movie-thumb/kali.webp";
import joker from "/assets/images/movie-thumb/joker.webp";
import deadpool from "/assets/images/movie-thumb/deadpool.webp";
import anyname from "/assets/images/movie-thumb/any-name.webp";
import yoshi from "/assets/images/movie-thumb/yoshi.webp";
import giikre from "/assets/images/movie-thumb/giirek.webp";
import kungfupanda from "/assets/images/movie-thumb/kung-fu-panda.webp";
import warfortheplanet from "/assets/images/movie-thumb/war-for-the-planet.webp";
import chosfies from "/assets/images/movie-thumb/chosfies.webp";
...
const tableData = [
  {
    ...
    title: "Game of Heros",
    author: "jenny",
    date_and_time: "2025-06-23 12:18:49",
    Views: "8099 views",
  },
  {
    movie: venom,
    title: "Venom",
    author: "jenny",
    date_and_time: "2024-12-28 11:10:29",
    Views: "2387 views",
  },
  {
    movie: rabbit,
    title: "Rabbit",
    author: "jenny",
    date_and_time: "2025-05-30 03:59:11",
    Views: "6779 views",
  },
  {
    movie: migration,
    title: "Migration",
    author: "jenny",
    date_and_time: "2025-05-23 08:31:29",
    Views: "977 views",
  },
  {
    movie: krishna,
    title: "Krishna",
    author: "jenny",
    date_and_time: "2025-05-23 08:15:01",
    Views: "3013 views",
  },
  {
    movie: kali,
    title: "Kali",
    author: "jenny",
    date_and_time: "2025-05-23 08:18:19",
    Views: "1742 views",
  },
  {
    movie: joker,
    title: "joker",
    author: "jenny",
    date_and_time: "2024-12-23 11:39:21",
    Views: "960 views",
  },
  {
    movie: deadpool,
    title: "Deadpool",
    author: "jenny",
    date_and_time: "2025-01-22 09:35:00",
    Views: "760 views",
  },
  {
    movie: anyname,
    title: "Any Name",
    author: "jenny",
    date_and_time: "2025-01-22 09:37:53",
    Views: "853 views",
  },
  {
    movie: yoshi,
    title: "YoShi",
    author: "jenny",
    date_and_time: "2024-12-23 11:41:16",
    Views: "775 views",
  },
  {
    movie: giikre,
    title: "Giikre",
    author: "jenny",
    date_and_time: "2024-12-23 11:40:57",
    Views: "1463 views",
  },
  {
    movie: kungfupanda,
    title: "Kung Fu Panda",
    author: "jenny",
    date_and_time: "2024-12-23 11:40:25",
    Views: "758 views",
  },
  {
    movie: warfortheplanet,
    title: "War For The Planet",
    author: "jenny",
    date_and_time: "2024-12-23 11:37:27",
    Views: "533 views",
  },
  {
    movie: chosfies,
    title: "Chosfies",
    author: "jenny",
    date_and_time: "2025-05-23 08:25:36",
    Views: "5028 views",
  },
  {
    movie: thehunter,
  ...
  },
  {
    ...
    render: function () {
      ...
      <div class="d-flex align-items-center list-user-action gap-2">
        ...
        <a title="View" class="btn btn-sm btn-icon btn-info-subtle rounded" data-table="action" href="#"><i class="ph ph-eye fs-6"></i></a>
      </div>
        `;
    },
  },
...
const MovieList = memo((props) => {
  ...
  const tabsData = [
    ...
    {
      id: "recommendedMovies_tab",
      label: `${t("addpage.recommended_movies")}`,
      content: <RecommendedMovieTab />,
    },
    {
      id: "relatedVideos_tab",
      label: `${t("addpage.related_videos")}`,
      content: <Related_Video />,
    },
  ...
  const EditMovie_Data = [
    { id: "general_tab", label: `${t("addpage.general")}`, content: <GeneralTabContent defaultCensorRating="U" time="02:30" /> },
    {
      id: "recommendedMovies_tab",
      label:  `${t("addpage.recommended_movies")}`,
      content: <RecommendedMovieTab />,
    ...
    { id: "tags_tab", label: `${t("addpage.tags")}`, content: <Tags /> },
    {
      id: "additionData_tab",
      label:  `${t("addpage.additional_data")}`,
      content: <Addition_Data  defalutLink="https://www.youtube.com/" rating="5"/>,
    },
    {
      id: "membershipLevel_tab",
      label: `${t("addpage.membership-level")}`,
          ...
          <Card.Body className="p-0">
            <div className="table-view table-responsive my-3 table-space">
              <table
                id="seasonTable"
                ref={tableRef}
                className="data-tables table custom-table movie_table dataTable no-footer mt-2"
              ></table>
            </div>
          </Card.Body>
...
const GeneralTabContent = (props) => {
  ...
  const { defaultCensorRating , time} = props
  ...
  const [censorRating, setCensorRating] = useState(defaultCensorRating);
  ...
  return (
    <div className="p-4 px-2">
      <Row>
        ...
        <Col lg={6}>
          <Form.Group className="form-group">
            <Form.Label>{t("addpage.movie-release-date")}</Form.Label>
            <Flatpickr
        ...
        <Col lg={6}>
          <Form.Group className="form-group">
            <Form.Label>{t("addpage.movie-censor-rating")}</Form.Label>
            <Form.Control
              type="text"
...
const RecommendedMovieTab = () => {
  const { t } = useTranslation();
  const recommended_movie = [
    { label: "Pushpa", value: "pushpa" },
    { label: "The Conjuring", value: "the_conjuring" },
    { label: "Giikre", value: "giikre" },
    { label: "Another Danger", value: "another_danger" },
    { label: "Kung Fu Panda", value: "kung_fu_panda" },
    { label: "John Wick", value: "john_wick" },
    { label: "Spiderman", value: "spiderman" },
    { label: "War For The Planet", value: "war_for_the_planet" },
  ];
  ...
  return (
    <Fragment>
      <div className="p-4 px-2">
        <Form.Group className="form-group">
          <Form.Label>{t("addpage.recommended_movies")}</Form.Label>
          <ChoicesJs
            options={recommended_movie}
            className="js-choice"
            select="multi"
          />
        </Form.Group>
...
const Related_Video = (props) => {
  const { t } = useTranslation();
  const related_video = [
    { label: "Little Krishna", value: "little_krishna" },
    { label: "Red Dog", value: "red_dog" },
    { label: "Frozen", value: "frozen" },
    { label: "Titanic", value: "titanic" },
    { label: "Adventure", value: "adventure" },
    { label: "Kung Fu Panda", value: "kung_fu_panda" },
    { label: "Red", value: "red" },
    { label: "The Crew", value: "the_crew" },
    { label: "Synchronic", value: "synchronic" },
    { label: "Lost In Space", value: "lost_in_space" },
    { label: "The Dragon King", value: "the_dragon_king" },
    { label: "Sonil", value: "sonil" },
    { label: "Guilty", value: "guilty" },
    { label: "Toddler", value: "toddler" },
    { label: "Charlie Chaplin", value: "charlie_chaplin" },
  ];
  const defatvalues = props.defatvalue ? related_video[0] : ""
  return (
    <Fragment>
      <div className="p-4 px-2">
        <Form.Group className="form-group">
          <Form.Label>{t("addpage.related_videos")}</Form.Label>
          <ChoicesJs
            options={related_video}
            className="js-choice"
            select="multi"
            defaultValue = {defatvalues}
          />
        </Form.Group>
      </div>
    </Fragment>
...
const Genres = () => {
  ...
  return (
    <Fragment>
      <div className="p-4 px-2">
        <Form.Group className="form-group mb-0">
          <Form.Label htmlFor="Choose_Movie_Genres">{t("addpage.choose-movie-genres")}</Form.Label>
          <ChoicesJs
...
const Tags = () => {
  ...
  return (
    <Fragment>
      <div className="p-4 px-2">
        <Form.Group className="form-group mb-0">
          <Form.Label htmlFor="Choose_Movie_Genres">{t("addpage.choose-movie-tags")}</Form.Label>
          <ChoicesJs
            options={tags_option}
            className="js-choice"
            select="multi"
...
const Addition_Data = (props) => {
  ...
  const handleRelatedProductChange = (e) => {
    const value = Array.from(
      e.target.selectedOptions,
      (option) => option.value
    );
    setRelatedProduct(value);
  };
        ...
        <Row>
          ...
          <Form.Group className="form-group">
            ...
            <Form.Check
              ...
              label={t("addpage.this-is-upcoming-movie")}
              checked={isUpcoming}
          ...
          <Col lg={6}>
            <Form.Group className="form-group">
              <ImageUpload
                uploadImageName={t("addpage.upload-potrait-image")}
                isUploadImageDefault={true}
                isRequiredStar={true}
                defaultImageUrl={movie}
              />
...
const Membership_Level = () => {
  ...
  return (
    <Fragment>
      <div className="p-4 px-2">
        <Form.Group className="form-group mb-0">
          <Form.Label htmlFor="Choose_Movie_Genres">{t("addpage.choose-pmp-levels")}</Form.Label>
          <ChoicesJs
