import React, { memo, Fragment, Suspense, useContext, useEffect, useState } from "react";
...
useEffect(() => {
  // Prevent duplicate overlay & double-start
  const existingSteps = document.querySelectorAll('.shepherd-element');
