    ...
    <Fragment>
      <div className="d-flex align-items-center">
        <Button
          ...
          onClick={() => {
            props.handleOffcanvas(), setShow1(!show1);
          }}
        >
      ...
      <Collapse in={show1}>
        <div className="navbar-collapse" id="navbarSupportedContent">
          <ul className="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0 me-3">
            <Dropdown as="li" className="nav-item me-0 me-xl-0 pt-1 ms-2">
              <Dropdown.Toggle as={CustomToggle} variant="nav-link ">
                <i className="ph ph-magnifying-glass fs-4 align-middle"></i>
              </Dropdown.Toggle>
              ...
              >
                <div className=" rounded-pill">
                  <span className="btn-inner">
                    <i className="ph ph-translate fs-4 align-middle"></i>
                  </span>
                </div>
              </Dropdown.Toggle>
            ...
            <Dropdown as="li" className="nav-item">
              <Dropdown.Toggle as={CustomToggle} variant="nav-link ">
                <div className=" btn-sm rounded-pill">
                  <i className="ph-fill ph-bell fs-4 align-middle"></i>
            ...
            <Dropdown as="li" className="nav-item theme-scheme-dropdown">
              <Dropdown.Toggle as={CustomToggle} variant="nav-link">
                <div className=" rounded-pill">
                  <span className="btn-inner">
                    <i className="ph-duotone ph-sun fs-4 align-middle"></i>
                  </span>
                </div>
              </Dropdown.Toggle>
              <Dropdown.Menu
            ...
            {/* <li className="nav-item iq-full-screen d-none  d-xl-block border-end" id="fullscreen-item" >
                           <a href="#" className="nav-link pe-3" id="btnFullscreen" data-bs-toggle="dropdown">
                              <span className="btn-inner">
                                 <i
                  className={`normal-screen ph ${
                    show === false
                      ? "ph-arrows-out-simple"
                      : "full-normal-screen ph-arrows-in-simple"
                  } fs-4 align-middle"`}
                ></i>
            ...
            <Nav.Item
              as="li"
              className=" iq-full-screen d-none d-xl-block border-end"
            ...
            >
              ...
              >
                <span className="btn-inner">
                  {show === false ? (
                  <i className="normal-screen ph ph-arrows-out-simple fs-4 align-middle"></i>
                  ) : (
                    <i className="full-normal-screen ph ph-arrows-in-simple  align-middle fs-4"></i>
                  )}
                </span>
              </Nav.Link>
            </Nav.Item>
            ...
            >
              ...
              <Dropdown.Menu variant="end">
                <Dropdown.Item
                  onClick={() => history("/app/user-profile")}
                  href="#"
                >
                  {t("header.profile")}
                </Dropdown.Item>
                <Dropdown.Item
                  onClick={() => history("/app/user-privacy-setting")}
                  href="#"
                >
