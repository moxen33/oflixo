...
export const getColorShadeTint = (color, value, dark) => {
  ...
  style.innerHTML = `
            [data-bs-theme-color="custom"] {
                ...
                ${color}-shade-90 :${shadeColor(value,90)};
                ${color}-shade-80 :${shadeColor(value,80)};
                ${color}-shade-60 :${shadeColor(value,60)};
                ${color}-shade-40 :${shadeColor(value,40)};
                ${color}-shade-20 :${shadeColor(value,20)};
                ${color}-shade-10 :${shadeColor(value,10)};
                ${color}-tint-90 :${shadeColor(value,90)};
                ${color}-tint-80 :${shadeColor(value,80)};
                ${color}-tint-60 :${shadeColor(value,60)};
                ${color}-tint-40 :${shadeColor(value,40)};
                ${color}-tint-20 :${shadeColor(value,20)};
                ${color}-tint-10 :${shadeColor(value,10)};
            }
